...
//        }
//
//        // Check if card is available in the pool
//
//        Mono<Boolean> cardExistForRoom = cardPoolService.cardExistInRoom(cardId, roomId);
//
...
//
//        return cardExistForRoom
//                .flatMap(exist -> {
//
//                    if (!exist) {
//                        publishCardError(roomId, userId, cardId, "Card does not exist!", "CARD_DOES_NOT_EXIST");
//                        return Mono.empty();
//                    }
//
