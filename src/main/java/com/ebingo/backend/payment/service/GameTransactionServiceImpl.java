...
public class GameTransactionServiceImpl implements GameTransactionService {
    ...
    @Override
    public Flux<GameTransactionDto> getPaginatedGameTransactions(String userSupabaseId, Integer page, Integer size, String sortBy) {
        ...
        return userProfileService.getUserProfileBySupabaseId(UUID.fromString(userSupabaseId))
                ...
                .doOnComplete(() -> log.info("Completed fetching game transactions for user: {}", userSupabaseId))
                .doOnError(e -> log.error("Failed to fetch game transactions: {}", e.getMessage(), e));
    }

    @Override
    public Mono<GameTransactionDto> getTransactionById(Long txnId, String userSupabaseId) {
        return userProfileService.getUserProfileBySupabaseId(UUID.fromString(userSupabaseId))
                .flatMap(up ->
