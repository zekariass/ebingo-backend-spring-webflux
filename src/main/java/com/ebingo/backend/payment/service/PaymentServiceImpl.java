...
public class PaymentServiceImpl implements PaymentService {
    ...
    @Override
    public Mono<Boolean> processPayment(String userId, BigDecimal amount, Long gameId) {
        return userProfileService.getUserProfileBySupabaseId(UUID.fromString(userId))
                ...
                .onErrorResume(ex -> {
                    log.error("Payment processing failed for userId={} gameId={}: {}", userId, gameId, ex.getMessage());
    ...
    public Mono<Boolean> processRefund(String userId, Long gameId) {
        return userProfileService.getUserProfileBySupabaseId(UUID.fromString(userId))
                ...
                .onErrorResume(ex -> {
                    log.error("Refund processing failed for userId={} gameId={}: {}", userId, gameId, ex.getMessage());
                    return Mono.just(false);
                });
    }
